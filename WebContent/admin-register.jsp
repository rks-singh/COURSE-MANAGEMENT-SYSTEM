...
<body>
	<div class="navbar navbar-inverse set-radius-zero">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"> <h1>E-Learning Portal</h1></a>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">&copy; 2023 E-Learning Portal</div>
			<div class="col-md-12">Design And Developed By || Ravi Shekhar Singh</div>
		</div>
	</div>
	</section>
	<!-- FOOTER SECTION END-->
